...
// DialerFunc defines the dialer used by easyRpc Client to connect to the server.
...
// Client represents an easyRpc Client.
...
// ClientPool represents an easyRpc Client Pool.
