...
func (ap *Appender) Encode(client *easyRpc.Client, msg *easyRpc.Message) *easyRpc.Message {
...
func (ap *Appender) Decode(client *easyRpc.Client, msg *easyRpc.Message) *easyRpc.Message {
