...
type ServiceManager interface {
	...
	ClientBy(serviceName string) (*easyRpc.Client, error)
}
...
func (list *serviceNodeList) next() (*easyRpc.Client, error) {
	list.mux.RLock()
...
func (s *serviceManager) ClientBy(serviceName string) (*easyRpc.Client, error) {
	s.mux.RLock()
	defer s.mux.RUnlock()
